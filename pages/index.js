...
const styles = {
  ...
  mainContainer: 'w-2/3 h-full m0auto flex mt-16',
  ...
  rightMain: 'flex flex-col flex-1 h-4/5 bh-[#1E2123] mt-6 rounded-lg overflow-y-scroll noScroll',
    ...
    <div className={styles.wrapper}>
      ...
      <div className={styles.mainContainer}>
        ...
        <div className={styles.rightMain}>
          ...
          {/* Map through our coins and for every coin make an Asset component */}
          {/* <Asset /> */}
          <div className={styles.rightMainItem}>
            <div className={styles.ItemTitle}>List</div>
            <AiOutlinePlus />
          </div>
        </div>
      </div>
